...
I care about how systems fail, not only whether they pass.

My engineering approach is built around ground truth, root-cause analysis, asymmetric failure cost, adversarial verification, bounded changes, explainability, and using AI agents for investigation as well as implementation.

**[Read my Engineering Principles →](./ENGINEERING_PRINCIPLES.md)**
...
<a href="https://github.com/Yashelly/Job-Seeker-Intelligence">
...
`Python` · `FastAPI` · `SQLite` · `Playwright`

[Repository](https://github.com/Yashelly/Job-Seeker-Intelligence)
